...
export default function SupplierListPage() {
  ...
  return (
    <div>
      <PageHeader
        title="Suppliers"
        subtitle="Distributors and part vendors"
        actions={
          <Button
            asChild
      ...
      <DataTable
        columns={[
          ...
          },
          {
            ...
            cell: (r) => (
              ...
              >
                ...
                <div>
                  <div className="text-slate-100">{r.supplier_name}</div>
          ...
          { key: "city", header: "City" },
          {
            ...
            align: "right",
            cell: (r) => (
              <span className="font-numeric">{r.payment_terms_days}d</span>
            ),
          },
          {
            key: "outstanding",
            ...
            cell: (r) => (
              <CurrencyText
                value={r.outstanding}
                className={r.outstanding > 0 ? "text-red-300" : ""}
              />
            ),
          },
          {
            ...
            cell: (r) => (
              <ListingRowActions
                ...
                queryKey="suppliers"
                itemLabel={
                  r.supplier_name || r.name || r.supplier_code || "supplier"
                }
              />
            ),
          },
