...
export default function InvoiceListPage() {
  ...
  return (
    <div>
      <PageHeader
        title="Invoices"
        subtitle="Confirmed sales and outstanding balances"
        actions={
          <Button
            asChild
      ...
      <div className="flex gap-3 mb-4">
        ...
        <Select
          value={getFilter("payment_status")}
          onValueChange={(v) =>
      ...
      <DataTable
        columns={[
          ...
          },
          {
            ...
            align: "right",
            cell: (r) => (
              <CurrencyText value={r.paid} className="text-emerald-400" />
            ),
          },
          {
            key: "balance",
            ...
            cell: (r) => (
              <CurrencyText
                value={r.balance}
                className={r.balance > 0 ? "text-red-300" : ""}
              />
            ),
          },
          {
          ...
          },
          {
            key: "delivery_status",
            header: "Delivery",
            cell: (r) => <StatusBadge status={r.delivery_status} />,
          },
          {
            key: "actions",
            header: "Actions",
            ...
            cell: (r) => (
              <ListingRowActions
                viewTo={`/sales/invoices/${r.id}`}
                deleteUrl={`/sales/invoices/${r.id}/`}
                queryKey="invoices"
                itemLabel={r.invoice_number || "invoice"}
              />
            ),
          },
        ]}
