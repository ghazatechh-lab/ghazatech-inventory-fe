...
export default function QuotationListPage() {
  ...
  return (
    <div>
      <PageHeader
        title="Quotations"
        subtitle="Sales quotes issued to customers"
        actions={
          <Button
            asChild
      ...
      <DataTable
        columns={[
          ...
          { key: "branch", header: "Branch", cell: (r) => r.branch.name },
          {
            key: "valid_until",
            header: "Valid until",
            cell: (r) => <DateText value={r.valid_until} />,
          },
          {
            key: "total",
            header: "Total",
          ...
          },
          {
            ...
            cell: (r) => (
              <ListingRowActions
                viewTo={`/sales/quotations/${r.id}`}
                deleteUrl={`/sales/quotations/${r.id}/`}
                queryKey="quotations"
                itemLabel={r.quotation_number || "quotation"}
              />
            ),
          },
        ]}
