...
export default function PayrollDetailModal({ payroll, onClose, onUpdated }) {
  ...
  return (
    <div className="fixed inset-0 z-[90] flex items-center justify-center overflow-y-auto bg-black/60 p-4">
      <div className="my-6 w-full max-w-4xl overflow-hidden rounded-2xl border bg-background shadow-2xl">
        ...
        <div className="space-y-6 p-5">
          ...
          <section>
            ...
            <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
              ...
              <MoneyCard label="Other Deductions" value={payroll.deductions} />
        ...
        <div className="flex flex-wrap justify-end gap-2 border-t bg-muted/20 p-5">
          <Button
            variant="outline"
            onClick={() =>
              window.open(
