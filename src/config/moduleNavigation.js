...
export const modules = [
...

  {
    ...
    shortTitle: "Sales",
    description:
      "Manage customers, quotations, orders, invoices, direct sales, service & repair, payments, returns, and pricing.",
    icon: BarChart3,
    path: "/sales",
    ...
    items: [
      ...
      {
        id: "sales-service-history",
        label: "Service History",
        to: "/sales/service/history",
        icon: History,
        permission: "sales.invoices.view",
      },
      {
...

  {
    ...
    shortTitle: "HRMS",
    description:
      "Manage employees, attendance, leave requests, payroll, salary history, certificates & letters, and document expiry.",
    icon: UserSquare2,
    path: "/hrms",
    ...
    items: [
      ...
      {
        id: "hrms-certificates-letters",
        to: "/hrms/certificates-letters",
